const data = [
  ...
  },
  {
    ...
    text: "요즘 대세인 OPEN AI API를 활용하여 만든 프로젝트입니다. <br>api를사용하는 방법에 대하여 공부하였고, <br>리액트 훅 사용에 대해 이해하는데 도움이 되었습니다. <br>배포 과정에서의 경로 오류 해결과 <br>깃허브에 리액트 페이지 호스팅 하는 방법을 공부했습니다. <br>하지만 어째서인지 openai의 API키 인증 문제로 <br>깃허브 서버에 올리면 돌아가지 않는군요...?<br>혹시 해결 법을 아신다면 알려주시길 바랍니다. ",
